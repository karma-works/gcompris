...
function(getQtPluginPaths _plugin_target _absolute_path _subdir _file)
  ...
  get_filename_component(_plugin_path_real ${_plugin_path} REALPATH)
  get_filename_component(_qt_plugins_path_real ${_qt_plugins_path} REALPATH)
  get_filename_component(_plugin_dir ${_plugin_path_real} PATH)
  file(RELATIVE_PATH _plugin_subdir ${_qt_plugins_path_real} ${_plugin_dir})
  if(_plugin_subdir MATCHES "^\\.\\.")
    file(TO_CMAKE_PATH "${_plugin_dir}" _plugin_dir_cmake)
    string(FIND "${_plugin_dir_cmake}" "/share/qt/plugins/" _plugins_pos)
    if(_plugins_pos GREATER_EQUAL 0)
      math(EXPR _plugin_subdir_pos "${_plugins_pos} + 18")
      string(SUBSTRING "${_plugin_dir_cmake}" ${_plugin_subdir_pos} -1 _plugin_subdir)
    endif()
  endif()
